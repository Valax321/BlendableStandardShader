Shader "Blending/Standard"
{
    Properties
    {
        ...
        _MetallicRoughness ("Metallic (RGB), Smoothness (A) 1", 2D) = "white" {}
        ...
        _MetallicRoughness2 ("Metallic (RGB), Smoothness (A) 2", 2D) = "white" {}
        ...
        _MetallicRoughness3 ("Metallic (RGB), Smoothness (A) 3", 2D) = "white" {}
        ...
        _MetallicRoughness4 ("Metallic (RGB), Smoothness (A) 4", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            float4 m1 = UNITY_SAMPLE_TEX2D_SAMPLER(_MetallicRoughness, _MainTex, IN.uv_MainTex) 
                        * float4(_Metallic, _Metallic, _Metallic, _Smoothness);
            ...
            float4 m2 = UNITY_SAMPLE_TEX2D_SAMPLER(_MetallicRoughness2, _MainTex, IN.uv_MainTex2) 
                        * float4(_Metallic2, _Metallic2, _Metallic2, _Smoothness2);
            ...
            float4 m3 = UNITY_SAMPLE_TEX2D_SAMPLER(_MetallicRoughness3, _MainTex, IN.uv_MainTex3) 
                        * float4(_Metallic3, _Metallic3, _Metallic3, _Smoothness3);
            ...
            float4 m4 = UNITY_SAMPLE_TEX2D_SAMPLER(_MetallicRoughness4, _MainTex, IN.uv_MainTex4) 
                        * float4(_Metallic4, _Metallic4, _Metallic4, _Smoothness4);
    ...
    FallBack "Diffuse"
    CustomEditor "Valax321.BlendableStandard.Editor.MetallicBlendableEditor"
}